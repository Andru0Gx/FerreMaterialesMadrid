...
export function BankAccountForm({ onSubmit, onCancel, initialData }: BankAccountFormProps) {
    ...
    const handleSubmit = (values: BankAccountFormValues) => {
        onSubmit({
            id: initialData?.id,
            ...values,
            accountNumber: values.type === "TRANSFERENCIA" ? values.accountNumber : undefined,
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>
                                {form.watch("type") === "PAGO_MOVIL" ? "Cédula/RIF" : "Cédula/RIF"}
                            </FormLabel>
                            <FormControl>
                                <Input
                                    placeholder={form.watch("type") === "PAGO_MOVIL" ? "V-12345678" : "J-12345678-9"}
                                    {...field}
                                />
                            </FormControl>
                            <FormMessage />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input placeholder="01XX-XXXX-XXXX-XXXX-XXXX" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input placeholder="04XX-XXX-XXXX" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
