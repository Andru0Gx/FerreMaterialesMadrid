...
export const promotions: Promotion[] = [
  {
    ...
    description: "Aprovecha nuestros descuentos de verano en herramientas de jardín",
    discountType: "percentage",
    discountValue: 15,
    startDate: "2023-06-01",
    endDate: "2023-08-31",
    applicableCategories: ["jardineria"],
    applicableProducts: ["tijeras-podar-profesionales"],
    minimumPurchase: 0,
    couponCode: "VERANO15",
    active: true,
  },
  {
    id: "promo-002",
    name: "2x1 en Pinturas",
    description: "Lleva 2 y paga 1 en pinturas seleccionadas",
    discountType: "buyXgetY",
    discountValue: 100,
    startDate: "2023-05-15",
    endDate: "2023-06-15",
    applicableCategories: ["pinturas"],
    applicableProducts: ["pintura-interior-blanco-mate"],
    minimumPurchase: 0,
    couponCode: "",
    active: true,
  },
